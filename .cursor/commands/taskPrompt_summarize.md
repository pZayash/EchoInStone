...
## Objective
Create a comprehensive summary of the recorging transcription from `speaker_transcriptions.csv` and save it to `summary.md`.

## Requirements

### Input
- Source file `speaker_transcriptions.csv`
...
1. **Overview**
   - Link to original recording video or file, it may be in first record of source file. Usially it has empty timestamps.
   - Brief description of the recording topic.
   - Main participants and their roles, if identifiable.
   - Recording format (meeting/discussion/lecture/live/demo/workshop)
   - Total duration/timeline.
   - Brief abstract of recording, up to 250 words.
   - Keywords: 5–8 terms used for indexing and searching the recording in databases.
...
3. **Decisions Made**
   - Document all decisions reached
...
4. **Next Steps**
   ...
   - **Future meetings:** If any future meetings where planned, create a separate section "Future Meetings" with:
